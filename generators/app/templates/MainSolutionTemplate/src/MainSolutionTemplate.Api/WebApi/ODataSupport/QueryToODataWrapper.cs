...
namespace MainSolutionTemplate.Api.WebApi.ODataSupport
{
  public class QueryToODataWrapper<TDto, TModel> : IEnumerable<TModel>, IQueryToODataWrapper
  {
    ...
    private Func<IQueryable<TDto>, IEnumerable<TModel>> _map;


      public QueryToODataWrapper(IQueryable<TDto> queryable, string query, Func<IQueryable<TDto>, IEnumerable<TModel>> map)
    {
