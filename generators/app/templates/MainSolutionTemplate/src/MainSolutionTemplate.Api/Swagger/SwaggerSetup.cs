    ...
    protected SwaggerSetup(HttpConfiguration configuration)
    {
      ...
      SwaggerSpecConfig.Customize(c =>
      {
        ...
        c.ApiInfo(new Info()
        {
          ...
          Description = EmbededResourceHelper.ReadResource("MainSolutionTemplate.Api.Swagger.loginForm.html", typeof(SwaggerSetup).Assembly)
        });
      });
      SwaggerUiConfig.Customize(c =>
      {
          ...
          var resourceAssembly = typeof(SwaggerSetup).Assembly;
